    ...
    : camera(NULL), vao(0), vbo(0), ebo(0), mbo(0)
{
    ...
    glVertexAttribPointer(3, 4, GL_FLOAT, GL_FALSE, (void*)(12 * sizeof(float)), (void*)0);
    glVertexAttribPointer(4, 4, GL_FLOAT, GL_FALSE, (void*)(12 * sizeof(float)), (void*)(4 * sizeof(float)));
    glVertexAttribPointer(5, 4, GL_FLOAT, GL_FALSE, (void*)(12 * sizeof(float)), (void*)(8 * sizeof(float)));
    glVertexAttribPointer(6, 4, GL_FLOAT, GL_FALSE, (void*)(12 * sizeof(float)), (void*)(12 * sizeof(float)));
